...
.. important::
   ...
   Used incorrectly, these functions can lead to malfunction, lockups, crashes of your board, and in extreme cases, hardware damage.
...
.. function:: reset_cause()
   ...
   Get the reset cause. See :ref:`machine_constants` for the possible return values.
...
.. function:: wake_reason()
   ...
   Get the wake reason. See :ref:`machine_constants` for the possible return values.
...
.. function:: bitstream(pin, encoding, timing, data, /)
   ...
   The accuracy of the timing varies between microcomputers. On the **Kookaberry** it
   will be close to +/-30ns.
